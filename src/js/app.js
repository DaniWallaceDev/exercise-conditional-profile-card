...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            <li><a href=${twitter}><i class="fab fa-twitter fs-5"></i></a></li>
            <li><a href=${github}><i class="fab fa-github fs-5"></i></a></li>
            <li><a href=${linkedin}><i class="fab fa-linkedin fs-5"></i></a></li>
            <li><a href=${instagram}><i class="fab fa-instagram fs-5"></i></a></li>
          </ul>
